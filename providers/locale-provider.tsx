...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "hero.loading": { it: "Caricamento dati...", en: "Loading data..." },
  ...
  "map.loading": { it: "Caricamento mappa...", en: "Loading map..." },
  ...
  "map.activity": { it: "Attività", en: "Activity" },
  "map.more_info": { it: "Ulteriori informazioni", en: "More info" },
  "map.filter_all": { it: "Tutti", en: "All" },
  "map.filter_active": { it: "Attivi recenti", en: "Recently active" },
