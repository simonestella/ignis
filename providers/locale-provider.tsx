...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "map.legend_low_elev": { it: "bassa quota", en: "low elevation" },
  "map.legend_mid_elev": { it: "quota media", en: "mid elevation" },
  "map.legend_high_elev": { it: "alta quota", en: "high elevation" },
  "map.legend_color_title": { it: "Colore = monitoraggio", en: "Color = monitoring" },
  "map.legend_monitored": { it: "Monitorato", en: "Monitored" },
  "map.legend_monitored_sub": { it: "altri osservatori USGS", en: "other USGS observatories" },
  "map.legend_unmonitored": { it: "Non monitorato", en: "Unmonitored" },
  "map.legend_unmonitored_sub": { it: "solo dati storici GVP", en: "historical GVP data only" },
  "map.legend_avo": { it: "Alaska Volcano Obs.", en: "Alaska Volcano Obs." },
  "map.legend_hvo": { it: "Hawaiian Volcano Obs.", en: "Hawaiian Volcano Obs." },
  "map.legend_cvo": { it: "Cascades Volcano Obs.", en: "Cascades Volcano Obs." },
  "map.legend_yvo": { it: "Yellowstone Volcano Obs.", en: "Yellowstone Volcano Obs." },
  "map.legend_mvo": { it: "Montserrat Volcano Obs.", en: "Montserrat Volcano Obs." },
